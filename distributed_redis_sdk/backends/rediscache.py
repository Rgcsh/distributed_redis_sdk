...
"""
from distributed_redis_sdk.backends.base import BaseCache, iteritems_wrapper
...
class RedisCache(BaseCache):
    ...
    def __init__(
        ...
        if node_url is None or not isinstance(node_url, str):
        ...
        client = redis.from_url(node_url)
